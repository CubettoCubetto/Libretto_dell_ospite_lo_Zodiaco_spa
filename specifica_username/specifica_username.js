...
async function handleLogin(event) {
    ...
    try {
        ...
        if(destination == "sendComments"){
            window.open("https://diegopirovanoit.github.io/Libro_dell_ospite/invia_commento/invia_commento.html?username=" + encodeURIComponent(username));
        }
        else{
            window.open("https://diegopirovanoit.github.io/Libro_dell_ospite/account_creato/account_creato.html?username=" + encodeURIComponent(username));
        }
